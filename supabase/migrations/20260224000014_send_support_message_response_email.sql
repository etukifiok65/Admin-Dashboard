-- ================================================================
-- SEND EMAIL WHEN ADMIN RESPONDS TO SUPPORT MESSAGE
-- ================================================================
-- This migration creates a trigger that sends an email to the message sender
-- when an admin responds to their support message.
...
-- Create trigger
DROP TRIGGER IF EXISTS trigger_send_support_message_response_email ON public.messages;
CREATE TRIGGER trigger_send_support_message_response_email
  AFTER UPDATE ON public.messages
  FOR EACH ROW
  EXECUTE FUNCTION send_support_message_response_email();
